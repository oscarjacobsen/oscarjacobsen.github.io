...
import { defineComponent, onMounted, ref, computed, resolveComponent, openBlock, createElementBlock, normalizeClass, createTextVNode, toDisplayString, Fragment, renderList, createBlock, createCommentVNode, withDirectives, createElementVNode, vModelText, onUpdated, nextTick, normalizeStyle, withModifiers, createApp } from 'vue';
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", {
    ...
    class: normalizeClass(["item", { hasSubitems: _ctx.hasSubitems }])
  }, [
    createTextVNode(toDisplayString(_ctx.item.title) + " ", 1 /* TEXT */),
    (_ctx.hasSubitems && _ctx.visibleSubitems)
      ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.item.subitems, (subitem) => {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (_ctx.visible)
    ? (openBlock(), createElementBlock("div", {
        ...
        (_ctx.searchBar)
          ? (openBlock(), createBlock(_component_Search, {
              key: 0,
          ...
          : createCommentVNode("v-if", true),
        (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.filtered, (item) => {
          return (openBlock(), createBlock(_component_Item, {
            key: item.title,
            item: item,
            delay: _ctx.delay / 2,
...
export { Item, Menu, Search, index as default };
